...
const MainContent = ({ lang, setLang }: { lang: Language, setLang: (l: Language) => void }) => {
  ...
  return (
    <div className="bg-[#1B2440] text-brand-dark font-sans min-h-[100dvh] overflow-y-auto snap-y snap-mandatory scroll-smooth no-scrollbar flex flex-col">
      ...
      {/* 1. HERO (Dark) */}
      <section id="about" className="min-h-[100dvh] snap-start relative flex flex-col justify-center overflow-hidden bg-brand-navy">
      ...
      {/* 2. SERVICES (Light) */}
      <section id="services" className="min-h-[100dvh] snap-start relative bg-[#F5F5F7] text-brand-navy flex flex-col justify-center py-24 overflow-hidden">
      ...
      {/* 3. PROCESS (Dark) */}
      <section id="process" className="min-h-[100dvh] snap-start bg-brand-navy text-white relative flex flex-col py-24">
      ...
      {/* 4. TEAM (Light) */}
      <section id="team" className="min-h-[100dvh] snap-start flex flex-col md:flex-row bg-[#F5F5F7] overflow-hidden">
      ...
      <section id="differentiators" className="min-h-[100dvh] snap-start bg-[#141B2D] text-white flex flex-col justify-center relative py-24">
      ...
      <section id="testimonials" className="min-h-[100dvh] snap-start bg-white text-brand-navy flex flex-col justify-center relative py-24">
      ...
      {/* 7. SHOWROOM (Dark) */}
      <section id="showroom" className="min-h-[100dvh] snap-start bg-[#111] text-white flex flex-col justify-center relative py-24">
      ...
      {/* 8. CONTACT (Light) */}
      <section id="contact" className="min-h-[100dvh] snap-start bg-white flex flex-col justify-center relative text-brand-navy pt-24 pb-0">
